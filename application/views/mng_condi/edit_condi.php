              ...
              <div class="main">              
                <div class="modal-content" style="margin-top:20px;">
				  <div class="modal-header">
					<h4 class="modal-title">更新申请流程内容</h4>
				  </div>      
					...
					<div class="modal-body">
					  <div class="info-edit">
			              ...
			              <label class="col-sm-2 control-label">排序：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $condi['sort']?>" 
			              ...
			              <label class="col-sm-2 control-label">标题：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $condi['condi_title']?>" 
			                   		disabled class="form-control form-control-sm" />
			                </div>
			            </div>
						<br><hr><br>
					  	...
					  	<?php //循环输出module?>
					  	<?php if($condi_module){ ?>
					  	<?php foreach($condi_module as $k=>$v){ ?>
					  		<!-- 空白模块 -->
					  		<?php if($v == 0){ ?>
					  			<div class="form-group form-group-sm">
...
<input type="hidden" id="condi_id" value="<?php echo @$condi_id?>" />
...
ready(function(){
			...
			$.ajax({
		      type : 'post',
		        ...
		        data : {'position':position,
						'type':type,
						'module_id':module_id,
						'parent':'condi',//所属内容类型的表名
						'parent_id':$("#condi_id").val() //所属内容类型的ID
			        	},
	...
	$("#back_button").click(function(){
		window.location = base_url + "mng_condi";
	});
});
