  ...
  <div class="listcenter-right">
    ...
    <div class="list-cen">
      <div class="newscenter-deta">
        <h2><?php echo $news_view['s_name'];?></h2>
        <h3>发布日期：<?php echo cover_time("Y.m.d",$news_view['s_time']);?>　　浏览次数：<?php echo $news_view['s_read'];?>次</h3>
          <div class="zhaiyao"><span class="red">摘要：</span><?php echo strip_tags($news_view['s_conj']);?></div>
          <div class="deta-center"><?php echo $news_view['s_content'];?></div>
        <div class="deta-page">
          <p class="fl"><?php echo a_prev($news_view['s_type'],$news_view['id'],"classid=".$class_data['id']);?></p> <p class="fr"><?php echo a_next($news_view['s_type'],$news_view['id'],"classid=".$class_data['id']);?></p>
        </div>
      </div>
    </div>
  </div>
