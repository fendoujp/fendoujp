                    		...
                    		<div class="col-sm-4">
	                            <div class="single-work sin-news">
	                                <a class="work-thumb mb-35" href="<?php echo func::loc_url().'art/cate/'.$v['article_category_id']?>">
	                                    <img src="<?php echo $v['article_category_img']?>" alt="">
	                                    <div class="work-hover"></div>
	                                </a>
	                                <div class="work-excerp">
	                                    <a href="<?php echo func::loc_url().'art/cate/'.$v['article_category_id']?>">
	                                    	<h2><?php echo $v['article_category_name']?></h2>
	                                    </a>
	                                    <span class="news-date"><?php echo $v['article_category_content']?></span>
	                                </div>
	                            </div>
	                        </div>
                    	<?php }?>
