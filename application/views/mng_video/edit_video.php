              ...
              <div class="main">
                ...
                <div class="modal-content" style="margin-top:20px;">
				  <div class="modal-header">
					<h4 class="modal-title">编辑视频内容</h4>
				  </div>      
					...
					<div class="modal-body">
					  <div class="info-edit">
			              ...
			              <label class="col-sm-2 control-label">排序：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $video['sort']?>" 
			            ...
			            <div class="form-group form-group-sm">
						  <label class="col-sm-2 control-label">分类：</label>
							<div class="col-sm-7">
							   <input type="text" value="<?php echo $video['video_category_title']?$video['video_category_title']:'无分类'?>" 
			                   		disabled class="form-control form-control-sm" />
							</div>
						</div>
					  	<div class="form-group form-group-sm">
			              <label class="col-sm-2 control-label">标题：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $video['video_title']?>" 
			                   		disabled class="form-control form-control-sm" />
			                </div>
			            </div>
						<div class="form-group form-group-sm">
						  <label class="col-sm-2 control-label">封面图：</label>
							<div class="col-sm-7">
							   <img src="<?php echo $video['video_img']?>" 
						...
						<br><hr><br>
					  	...
					  	<?php //循环输出module?>
					  	<?php if($video_module){ ?>
					  	<?php foreach($video_module as $k=>$v){ ?>
					  		<!-- 空白模块 -->
					  		<?php if($v == 0){ ?>
					  			<div class="form-group form-group-sm">
...
ready(function(){
			...
			$.ajax({
		      type : 'post',
		        ...
		        data : {'position':position,
						'type':type,
						'module_id':module_id,
						'parent':'video',//所属内容类型的表名
						'parent_id':$("#video_id").val() //所属内容类型的ID
			        	},
	...
	$("#back_button").click(function(){
		window.location = base_url + "mng_video/video";
	});
});
