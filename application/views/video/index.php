                    	...
                    	<?php foreach($video_list as $k=>$v){ ?>
                    		<div class="col-sm-4">
	                            <div class="single-work sin-news">
	                                <a class="work-thumb mb-35" href="<?php echo func::loc_url().'video/show/'.$v['video_id']?>">
	                                    <img src="<?php echo $v['video_img']?>" alt="">
	                                    <div class="work-hover"></div>
	                                </a>
	                                <div class="work-excerp">
	                                    <a href="<?php echo func::loc_url().'video/show/'.$v['video_id']?>">
	                                    	<h2><?php echo $v['video_title']?></h2>
	                                    </a>
	                                    <span class="news-date"><?php echo $v['ct']?></span>
	                                </div>
	                            </div>
	                        </div>
                    	<?php }?>
