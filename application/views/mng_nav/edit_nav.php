              ...
              <div class="main">              
                <div class="modal-content" style="margin-top:20px;">
				  <div class="modal-header">
					<h4 class="modal-title">更新导航栏内容</h4>
				  </div>      
					...
					<div class="modal-body">
					  <div class="info-edit">
			              ...
			              <label class="col-sm-2 control-label">排序：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $nav['sort']?>" 
			              ...
			              <label class="col-sm-2 control-label">标题：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $nav['nav_title']?>" 
			                   		disabled class="form-control form-control-sm" />
			                </div>
			            </div>
						<br><hr><br>
...
ready(function(){
			...
			$.ajax({
		      type : 'post',
		        ...
		        data : {'position':position,
						'type':type,
						'module_id':module_id,
						'parent':'nav',//所属内容类型的表名
						'parent_id':$("#nav_id").val() //所属内容类型的ID
			        	},
	...
	$("#back_button").click(function(){
		window.location = base_url + "mng_nav";
	});
});
