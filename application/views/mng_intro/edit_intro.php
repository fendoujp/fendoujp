					...
					<div class="modal-body">
					  <div class="info-edit">
			              ...
			              <label class="col-sm-2 control-label">排序：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $intro['sort']?>" 
			              ...
			              <label class="col-sm-2 control-label">标题：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $intro['intro_title']?>" 
			                   		disabled class="form-control form-control-sm" />
			                </div>
			            </div>
						<br><hr><br>
...
<input type="hidden" id="intro_id" value="<?php echo @$intro_id?>" />
...
ready(function(){
			...
			$.ajax({
		      type : 'post',
		        ...
		        data : {'position':position,
						'type':type,
						'module_id':module_id,
						'parent':'intro',//所属内容类型的表名
						'parent_id':$("#intro_id").val() //所属内容类型的ID
			        	},
	...
	$("#back_button").click(function(){
		window.location = base_url + "mng_intro";
	});
});
