              ...
              <div class="main">
                ...
                <div class="modal-content" style="margin-top:20px;">
				  <div class="modal-header">
					<h4 class="modal-title">更新经验分享内容</h4>
				  </div>      
					...
					<div class="modal-body">
					  <div class="info-edit">
			              ...
			              <label class="col-sm-2 control-label">排序：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $exp_share['sort']?>" 
			              ...
			              <label class="col-sm-2 control-label">作者：</label>
			                <div class="col-sm-7">
			                   <input type="text" value="<?php echo $exp_share['exp_share_name']?>" 
			                   		disabled class="form-control form-control-sm" />
			                </div>
			            </div>
						<div class="form-group form-group-sm">
						  <label class="col-sm-2 control-label">标题：</label>
							<div class="col-sm-7">
							   <input type="text" value="<?php echo $exp_share['exp_share_note']?>" 
			                   		disabled class="form-control form-control-sm" />
							</div>
						</div>
						<div class="form-group form-group-sm">
						  <label class="col-sm-2 control-label">封面图：</label>
							<div class="col-sm-7">
							   <img src="<?php echo $exp_share['exp_share_img']?>" 
						...
						<br><hr><br>
					  	...
					  	<?php //循环输出module?>
					  	<?php if($exp_share_module){ ?>
					  	<?php foreach($exp_share_module as $k=>$v){ ?>
					  		<!-- 空白模块 -->
					  		<?php if($v == 0){ ?>
					  			<div class="form-group form-group-sm">
...
<input type="hidden" id="exp_share_id" value="<?php echo @$exp_share_id?>" />
...
ready(function(){
			...
			$.ajax({
		      type : 'post',
		        ...
		        data : {'position':position,
						'type':type,
						'module_id':module_id,
						'parent':'exp_share',//所属内容类型的表名
						'parent_id':$("#exp_share_id").val() //所属内容类型的ID
			        	},
	...
	$("#text_modal_submit").click(function(){
		...
		//获取exp_share_id
		var exp_share_id = $("#exp_share_id").val();
		...
		$.ajax({
	      type : 'post',
	        ...
	        data : {'op':op,
		        	...
		        	'position':position,
					'parent':'exp_share',//所属内容类型的表名
					'parent_id':exp_share_id //所属内容类型的ID
		        	},
	        success : function(response){
		     //错误处理
	          if(!errorMsg(response)) {
	...
	$("#back_button").click(function(){
		window.location = base_url + "mng_home/exp_share_list";
	});
});
