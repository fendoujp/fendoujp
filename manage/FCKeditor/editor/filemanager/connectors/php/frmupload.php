...
<table width="100%"  cellspacing="1" cellpadding="3">
  ...
  Operating system:
  <?php //php服务器变量
  echo PHP_OS;?></td><td>Server name:<? echo $_SERVER['SERVER_NAME'];?><td>Server IP:<? echo gethostbyname($_SERVER['SERVER_NAME']);?></tr><tr></td>
    <td>Server time:<? echo date("Y年m月d日 h:i:s",time());?> <a href="frmupload.php"><b>本页</b></a></td>
    <td>Server port :<? echo $_SERVER['SERVER_PORT'];  ?>
  </td></tr>
</table>
<hr>
...
<hr>
<table><tr><td>Home dir:<a href=""><?php echo $_SERVER['DOCUMENT_ROOT'];?></a></td></tr><tr><td>Current dir of contents：<?php
